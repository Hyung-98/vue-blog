<template>
  <div class="login_popup signup" v-if="$store.state.login.popup" @click.self="loginClose">
    <div class="popup_con">
      <div class="welcome">
      ...
      <div class="login">
        <section>
          <button type="button" class="close_btn" @click="loginClose">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" tabindex="1" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
          ...
          <form @submit.prevent="signupFn">
            <input type="email" id="email" name="uid" placeholder="이메일을 입력하세요." v-model="user_id">
          ...
          <ul class="social">
            <li class="github">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                ...
                <g mask="url(#github)"><path fill="currentColor" d="M0 0h20v20H0z"></path></g>
              </svg>
            </li>
            <li class="google">
            ...
            <li class="facebook">
              <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                ...
                <g mask="url(#facebook)"><path fill="#fff" d="M0 0h20v20H0z"></path></g>
              </svg>
            </li>
          </ul>
        </section>
        <section>
          <div class="signup">계정이 이미 있으신가요? <strong @click="this.$store.state.login.count--">로그인</strong></div>
        </section>
      </div>
    </div>
  </div>
